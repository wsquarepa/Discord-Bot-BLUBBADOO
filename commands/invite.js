//link: https://discord.com/oauth2/authorize?&client_id=596715111511490560&scope=bot&permissions=1056435583
module.exports = {
	name: 'invite',
    ...
    execute(message, args, mention) {
        message.client.guilds.cache.find(x => x.id == "712438988547555448")
            .channels.cache.find(x => x.id == "714151494491963473").createInvite({
                ...
                message.channel.send("**Bot invite is here:** <https://discord.com/oauth2/authorize?&client_id=596715111511490560&scope=bot&permissions=1056435583> \n" + 
